...
import 'package:ota/channels/example_noreturn/data_sources/example_channel_data_source.dart';
import 'package:ota/channels/example_noreturn/data_sources/example_mock_data_source.dart';
...
class ExampleRepositoryImpl implements ExampleRepository {
  ...
  Future<Either<Failure, SuccessResponse>> invokeExampleMethod(
    ...
    try {
      SuccessResponse? response = await exampleChannelDataSource
