...
abstract class OtaBookingDetailHandlerDataSource extends Disposer {
...
class OtaBookingDetailHandlerDataSourceImpl
  ...
  OtaBookingDetailHandlerDataSourceImpl({OtaChannel? otaMethodChannel}) {
  ...
  StreamSubscription handleMethodChannel(
    ...
    return otaMethodChannel!.handleNativeMethod(methodName, (data) {
      nativeResponse(OtaBookingDetailHandlerModelChannel.fromMap(data));
    });
  }
