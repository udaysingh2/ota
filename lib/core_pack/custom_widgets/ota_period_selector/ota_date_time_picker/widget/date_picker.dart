  ...
  Widget _buildHourPicker(double offAxisFraction,
    ...
    return NotificationListener<ScrollNotification>(
      ...
      child: CupertinoPicker(
        ...
        looping: true,
        selectionOverlay: isHourPickerScrolling
            ...
            : Container(
                ...
                child: Center(
                  child: Text(
                    localizations.datePickerMinute(selectedDateTime.hour),
          ...
          (int index) {
            ...
            return itemPositioningBuilder(
              ...
              Padding(
                ...
                child: Text(
                  localizations.datePickerHour(displayHour).padLeft(2, '0'),
                  style:
  ...
  Widget _buildMinutePicker(double offAxisFraction,
    ...
    return NotificationListener<ScrollNotification>(
      ...
      child: CupertinoPicker(
        ...
        looping: true,
        selectionOverlay: (isMinutePickerScrolling)
            ? const SizedBox.shrink()
            : Container(
                decoration: const BoxDecoration(
                  color: AppColors.kTrueWhite,
                ...
                child: Center(
                  child: Text(
                    localizations.datePickerMinute(selectedDateTime.minute),
                    style: AppTheme.kBodyMedium
                        .copyWith(color: AppColors.kSecondary),
                  ),
                ),
        ...
        children: List<Widget>.generate(
          ...
          (int index) {
            ...
            // int selectedMin = selectedDateTime.minute;
            // bool isSelected = selectedMin == minute;
            return itemPositioningBuilder(
              context,
              Padding(
                padding: const EdgeInsets.only(top: kSize5),
