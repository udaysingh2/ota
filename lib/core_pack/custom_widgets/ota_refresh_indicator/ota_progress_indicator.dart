...
///  * [RefreshIndicator], which automatically displays a [CircularProgressIndicator]
///    when the underlying vertical scrollable is overscrolled.
class OtaRefreshProgressIndicator extends CircularProgressIndicator {
  ...
  ///
  /// {@macro flutter.material.ProgressIndicator.ProgressIndicator}
  const OtaRefreshProgressIndicator({
    Key? key,
    double? value,
    Color? backgroundColor,
    Animation<Color?>? valueColor,
  ...
  @override
  RefreshProgressIndicatorState createState() =>
      RefreshProgressIndicatorState();
}

class RefreshProgressIndicatorState extends CircularProgressIndicatorState {
    ...
    return widget._buildSemanticsWrapper(
      ...
      child: Container(
        ...
        child: Material(
          ...
          elevation: 0.0, //OTA- Default was 2.0
          child: Padding(
