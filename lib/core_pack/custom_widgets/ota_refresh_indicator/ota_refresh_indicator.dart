...
import 'ota_progress_indicator.dart';
...
/// [OtaRefreshIndicator] far enough to demonstrate that they want the app to
/// refresh. The returned [Future] must complete when the refresh operation is
/// finished.
///
/// Used by [OtaRefreshIndicator.onRefresh].
...
/// Used to configure how [OtaRefreshIndicator] can be triggered.
...
///
/// The trigger mode is configured by [OtaRefreshIndicator.triggerMode].
///
/// ## Troubleshooting
///
/// ### Refresh indicator does not show up
///
/// The [OtaRefreshIndicator] will appear if its scrollable descendant can be
/// overscrolled, i.e. if the scrollable's content is bigger than its viewport.
/// To ensure that the [OtaRefreshIndicator] will always appear, even if the
...
/// ```
///
/// A [OtaRefreshIndicator] can only be used with a vertical scroll view.
///
/// See also:
///
///  * <https://material.io/design/platform-guidance/android-swipe-to-refresh.html>
///  * [OtaRefreshIndicatorState], can be used to programmatically show the refresh indicator.
///  * [RefreshProgressIndicator], widget used by [OtaRefreshIndicator] to show
///    the inner circular progress spinner during refreshes.
///  * [CupertinoSliverRefreshControl], an iOS equivalent of the pull-to-refresh pattern.
///    Must be used as a sliver inside a [CustomScrollView] instead of wrapping
///    around a [ScrollView] because it's a part of the scrollable instead of
///    being overlaid on top of it.
class OtaRefreshIndicator extends StatefulWidget {
  ...
  /// Defines how this [OtaRefreshIndicator] can be triggered when users overscroll.
  ///
  /// The [OtaRefreshIndicator] can be pulled out in two cases,
  ...
  @override
  OtaRefreshIndicatorState createState() => OtaRefreshIndicatorState();
}

/// Contains the state for a [OtaRefreshIndicator]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class OtaRefreshIndicatorState extends State<OtaRefreshIndicator>
    with TickerProviderStateMixin<OtaRefreshIndicator> {
  ...
  @override
  void didUpdateWidget(covariant OtaRefreshIndicator oldWidget) {
  ...
  ///
  /// Creating the [OtaRefreshIndicator] with a [GlobalKey<RefreshIndicatorState>]
  /// makes it possible to refer to the [OtaRefreshIndicatorState].
  ///
  /// The future returned from this method completes when the
  /// [OtaRefreshIndicator.onRefresh] callback's future completes.
  ///
                    ...
                    builder: (BuildContext context, Widget? child) {
                      return Column(
                        children: [
                          ...
                          //OTA- Code to have Text in loading.
                          if (widget.text != null)
                            Padding(
