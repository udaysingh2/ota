...
class OtaReservationDetailsWidget extends StatelessWidget {
  ...
  const OtaReservationDetailsWidget({
    Key? key,
    ...
    this.nightLabel = AppLocalizationsStrings.nights,
    this.roomLabel = AppLocalizationsStrings.roomLabel,
    this.guestName = "",
  }) : super(key: key);
