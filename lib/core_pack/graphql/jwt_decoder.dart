...
class JwtDecoder {
  static String? _oldToken;
  static Map<String, dynamic>? _oldDecodedData;
  ...
  static Map<String, dynamic> decode(String token) {
    //called this function to get  cache in memory.
    if (isOldTokenSameAsNew(token)) {
      return getOldDecodedData();
    }
    ...
    try {
      ...
      //called this function to set  cache in memory.
      setOldDecodedData(decodedPayload);
      setOldToken(token);
  ...
  static void setOldDecodedData(Map<String, dynamic> oldDecodedData) {
    _oldDecodedData = oldDecodedData;
  }

  static Map<String, dynamic> getOldDecodedData() {
    return _oldDecodedData ?? {};
  }

  static void setOldToken(String newToken) {
    _oldToken = newToken;
  }

  static bool isOldTokenSameAsNew(String newToken) {
    if (_oldToken == null) return false;
    if (_oldToken!.trim().isEmpty) return false;
    if (_oldToken == newToken) return true;
    return false;
  }
