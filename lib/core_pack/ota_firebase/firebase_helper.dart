...
class FirebaseHelper {
  ...
  static addKeyValue(
    ...
    _parameterGlobal[eventName]![key] = value != null
  ...
  static addBoolValue(
      {required String eventName, required String key, required bool? value}) {
    if (_parameterGlobal[eventName] == null) {
      return;
    }
    _parameterGlobal[eventName]![key] =
  ...
  void addUserId({required String eventName}) {
    if (_parameterGlobal[eventName] == null) {
      return;
    }
    _parameterGlobal[eventName]!["user_id"] = getLoginProvider().userId;
  }
  ...
  static addKeyWithPercentValue(
    ...
    _parameterGlobal[eventName]![key] =
        result != 0 ? "${result.toStringAsFixed(2)}%" : "0.00%";
  }

  static addDoubleWithPercentValue(
      {required String eventName,
      required String key,
      required double? value}) {
    if (_parameterGlobal[eventName] == null) {
