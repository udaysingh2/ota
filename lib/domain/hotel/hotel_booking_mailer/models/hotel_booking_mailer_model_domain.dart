...
class HotelBookingMailerModelDomain {
  HotelBookingMailerModelDomain({
    this.sendEmailConfirmation,
  });

  final SendEmailConfirmation? sendEmailConfirmation;

  factory HotelBookingMailerModelDomain.fromJson(String str) =>
      HotelBookingMailerModelDomain.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory HotelBookingMailerModelDomain.fromMap(Map<String, dynamic> json) =>
      HotelBookingMailerModelDomain(
