...
class OtaBookingMailerModelDomain {
  OtaBookingMailerModelDomain({
    this.sendEmailConfirmation,
  });

  final SendEmailConfirmation? sendEmailConfirmation;

  factory OtaBookingMailerModelDomain.fromJson(String str) =>
      OtaBookingMailerModelDomain.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory OtaBookingMailerModelDomain.fromMap(Map<String, dynamic> json) =>
      OtaBookingMailerModelDomain(
