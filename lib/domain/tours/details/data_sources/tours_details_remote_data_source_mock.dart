...
class TourDetailsMockDataSourceImpl implements TourDetailsRemoteDataSource {
  TourDetailsMockDataSourceImpl();
  @override
  Future<TourDetail> getTourDetails(TourDetailArgumentDomain argument) async {
    await Future.delayed(const Duration(seconds: 1));
    return TourDetail.fromJson(_responseMock);
  }
  ...
  Future<TourDetail> getTourPackageDetails(
    ...
    await Future.delayed(const Duration(seconds: 1));
    return TourDetail.fromJson(_responsePackageDetailsMock);
  }
}
		...
		"promotionList": [{
          ...
          "childPaxId": "MA01010002",
					"childInfo": {
						"minAge": 3,
						"maxAge": 8,
						"description": "<ul style=“list-style-type:circle”><li>First Item</li><li>Second Item</li><li>Third Item</li></ul>"
					},
					"currency": "THB",
					"refCode": "CL213",
					"serviceId": "",
...
var _responsePackageDetailsMock = '''
{
	"data": {
		"getTourDetails": {
			"data": {
				...
				"tour": {
					...
					"packages": [{
						...
						"childInfo": {
							"minAge": 3,
							"maxAge": 8,
							"description": "<p>(Activity Rate/ Child Policy Description)</p>"
						},
						"currency": "THB",
						"refCode": "CL213",
						"serviceId": "",
