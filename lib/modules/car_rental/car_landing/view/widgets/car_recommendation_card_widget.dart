...
class CarRecommendedLocationsWidget extends StatelessWidget {
  ...
  Widget _buildRecommendationCard(
      CarRecommendedLocationModel recommendationsModel, int index) {
    return Material(
      child: InkWell(
