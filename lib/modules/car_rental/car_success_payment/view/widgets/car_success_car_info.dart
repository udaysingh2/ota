...
class CarSuccessCarInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _getSubHeading(context, bookingUrn),
        const SizedBox(
          height: kSize8,
        ),
  ...
  Widget _getSubHeading(BuildContext context, String? bookingUrn) {
    return Text(
      '${getTranslated(context, AppLocalizationsStrings.referenceId)}${':'}${' '}$bookingUrn',
