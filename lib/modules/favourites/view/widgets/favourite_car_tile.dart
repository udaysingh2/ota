...
class FavouriteCarTile extends StatelessWidget {
  final FavouritesCarViewModel? favourites;
  final Function()? onTap;

  const FavouriteCarTile({
    Key? key,
    this.favourites,
    this.onTap,
  }) : super(key: key);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          IconTextWidget(
                            text: getTranslated(
                              context,
                              AppLocalizationsStrings.carRentalsService,
                            ),
                            iconName: _kCarIconAsset,
  ...
  Widget _buildImageCard(BuildContext context) {
    String imageUrl = favourites?.imageUrl ?? '';
    ...
    return Stack(
      children: [
        ...
        if (favourites?.promotionListLine1 != null &&
            favourites!.promotionListLine1.isNotEmpty)
          Positioned(
            top: 0,
            right: 0,
            child: _buildPromoImage(
              context,
              favourites?.promotionListLine1 ?? '',
              favourites?.promotionListLine2 ?? '',
            ),
          ),
      ],
    );
