...
class OtaTnaPlaylistCard extends StatelessWidget {
  final String name;
    ...
    return InkWell(
      ...
      child: Column(
        ...
        children: [
          ...
          (capsulePromotion != null && capsulePromotion!.isNotEmpty)
              ? KeyAmenitiesWidget(_amenitiesList)
              : const SizedBox(height: kSize10),
          _buildName(),
          _buildCategoryLocationWidget(),
          if (price != null) const SizedBox(height: kSize4),
  ...
  List<String> get _amenitiesList {
    ...
    for (TnaCapsulePromotion capsule in capsulePromotion!) {
        ...
        text: TextSpan(
          children: [
            TextSpan(
              ...
              style: AppTheme.kBody.copyWith(color: AppColors.kGrey20),
            ),
            WidgetSpan(
              alignment: PlaceholderAlignment.middle,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: kSize4),
                child: Text(priceText, style: AppTheme.kHeadline3),
              ),
            ),
            TextSpan(
              text: getTranslated(
