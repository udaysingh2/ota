...
const kAboutTheTicketsKey = "AboutTheTickets";
const kConditionsOfUseKey = "ConditionsOfUse";
const kHowToUseKey = "HowToUse";

class TicketDescriptionScreen extends StatefulWidget {
  const TicketDescriptionScreen({Key? key}) : super(key: key);

  @override
  TicketDescriptionScreenState createState() => TicketDescriptionScreenState();
}

class TicketDescriptionScreenState extends State<TicketDescriptionScreen> {
  @override
  Widget build(BuildContext context) {
    TicketInformation argument =
        ModalRoute.of(context)?.settings.arguments as TicketInformation;
    return Scaffold(
      appBar: OtaAppBar(
        title: getTranslated(context, AppLocalizationsStrings.ticketDetails),
        isCenterTitle: true,
      ),
      body: OtaChipSegment(
        chipData: [
          ChipData(
              ...
              widget: Expanded(child: _buildAboutTheTickets(argument))),
          ChipData(
  ...
  Widget _buildAboutTheTickets(TicketInformation info) {
    bool isClosingHours =
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        key: const PageStorageKey<String>(kAboutTheTicketsKey),
        child: Column(
  ...
  Widget _buildHowToUse(TicketInformation info) {
  ...
  Widget _buildConditionsOfUse(TicketInformation info) {
