...
class GetTicketDetailsWidget extends StatelessWidget {
  final List<TicketTypeViewModel> ticketList;
  final EdgeInsets padding;
  const GetTicketDetailsWidget({
    Key? key,
  ...
  List<Widget> getTicketInfo(BuildContext context) {
    ...
    ticketWidgetList.add(const SizedBox(height: kSize16));
    for (TicketTypeViewModel ticket in ticketList) {
