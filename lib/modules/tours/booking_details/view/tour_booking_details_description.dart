...
class TourBookingDetailDescriptionScreen extends StatefulWidget {
  const TourBookingDetailDescriptionScreen({Key? key}) : super(key: key);

  @override
  TourBookingDetailDescriptionScreenState createState() =>
      TourBookingDetailDescriptionScreenState();
}

class TourBookingDetailDescriptionScreenState
    extends State<TourBookingDetailDescriptionScreen> {
  @override
  Widget build(BuildContext context) {
    TourBookingInformation argument =
        ModalRoute.of(context)?.settings.arguments as TourBookingInformation;

    return Scaffold(
      appBar: OtaAppBar(
        title: getTranslated(
            context, AppLocalizationsStrings.additionalTourDetail),
        isCenterTitle: true,
      ),
      body: OtaChipSegment(
        chipData: [
  ...
  Widget _buildAboutTheTour(TourBookingInformation info) {
    bool isClosingHours =
  ...
  Widget _buildHowToUse(TourBookingInformation info) {
  ...
  Widget _buildConditionsOfUse(TourBookingInformation info) {
