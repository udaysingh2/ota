...
class HotelDetailUseCaseImplErrorCasesMock implements HotelDetailUseCasesImpl {
  @override
  ...
  Future<Either<Failure, IsFavoritesDomain>?> checkFavouriteHotel(
    ...
    String json = fixture("hotel/check_favorite_true.json");
  ...
  Future<Either<Failure, AddFavoriteModelDomain>?> addFavouriteHotel(
    ...
    String json = fixture("hotel/add_favorite_success.json");
