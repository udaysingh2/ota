...
import 'package:ota/domain/ota_booking_mailer/data_sources/ota_booking_mailer_mock.dart';
...
void main() {
  ...
  group("OTA booking mailer screen", () {
    OtaBookingMailerRepositoryImpl.setMockInternet(InternetSuccessMock());
    testWidgets('OTA booking mailer widget', (WidgetTester tester) async {
      OtaBookingMailerRemoteDataSourceImpl.setMock(GraphQlResponseMock(
        result: jsonDecode(OtaBookingMailerMockDataSourceImpl.getMockData()),
      ));
            ...
            body: Builder(builder: (context) {
              return TextButton(
                ...
                onPressed: () => Navigator.pushNamed(
                    context, AppRoutes.otaBookingMailerScreen,
    ...
    testWidgets('OTA booking mailer widget negetive',
        (WidgetTester tester) async {
      OtaBookingMailerRemoteDataSourceImpl.setMock(
