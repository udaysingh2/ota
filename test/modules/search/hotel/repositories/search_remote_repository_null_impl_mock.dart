...
class SearchRepositoryImplNullDataMock implements SearchRepositoryImpl {
  @override
  ...
  Future<Either<Failure, SearchRecommendationModel>>
    ...
    String json = fixture("search/null_recommendation_data.json");
  ...
  Future<Either<Failure, SearchSuggestionModel>> getSearchSuggestionData(
    ...
    String json = fixture("search/null_data.json");
  ...
  Future<Either<Failure, HotelRecommendationModelDomain>>
    ...
    String json = fixture("search/null_hotel_recommendation_data.json");
