          ...
          home: Scaffold(
            body: Builder(builder: (context) {
              return TextButton(
                ...
                onPressed: () async {
                  SuperAppToERecipt superAppToERecipt = SuperAppToERecipt();
                  superAppToERecipt.handle(context: context);
                  superAppToERecipt.onHandleSuccess;
                  superAppToERecipt.dispose();
                },
              );
            }),
          ),
