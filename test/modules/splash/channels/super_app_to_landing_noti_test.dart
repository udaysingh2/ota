          ...
          home: Scaffold(
            body: Builder(builder: (context) {
              return TextButton(
                ...
                onPressed: () async {
                  SuperAppToLandingNoti superAppToLandingNoti =
                      SuperAppToLandingNoti();
                  superAppToLandingNoti.handle(context: context);
                  superAppToLandingNoti.onHandleSuccess;
                  superAppToLandingNoti.dispose();
                },
              );
            }),
          ),
