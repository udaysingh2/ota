          ...
          home: Scaffold(
            body: Builder(builder: (context) {
              return TextButton(
                ...
                onPressed: () async {
                  SuperAppToPropertyDetail superAppToPropertyDetail =
                      SuperAppToPropertyDetail();
                  superAppToPropertyDetail.handle(context: context);
                  superAppToPropertyDetail.onHandleSuccess;
                  superAppToPropertyDetail.dispose();
                },
              );
            }),
          ),
